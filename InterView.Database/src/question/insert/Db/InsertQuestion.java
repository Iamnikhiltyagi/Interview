...
public class InsertQuestion {
	...
	public void midinsertingOption(String option, String qid, char option_label, String option_id)
			throws SQLException, ClassNotFoundException {
		String oplabel = Character.toString(option_label);
		/*
		 * Class.forName(jdbcURL); Connection connection =
		...
		Connection connection=ConnectionProvider.getConnection();
		System.out.println("Connection Success\n");
		PreparedStatement preparedStatement = connection.prepareStatement("insert into midmcqoptions values(?,?,?,?);");
	...
	public void midinsertingQuestion(String qid, String question, String correct_option)
			throws SQLException, ClassNotFoundException {
		/*
		 * Class.forName(jdbcURL); Connection connection =
		 * DriverManager.getConnection(
		...
		Connection connection=ConnectionProvider.getConnection();
		System.out.println("Connection Success\n");
		PreparedStatement preparedStatement = connection.prepareStatement("insert into mcq_midLevelQuestion values(?,?,?,?);");
